                                ...
                                <div class="card text-white bg-flat-color-3">
                                    <div class="card-body">
                                        <div class="card-left pt-1 float-left">
                                            <h3 class="mb-0 fw-r">
                                                <span class="count">{{$availableassistant}}</span>
                                            </h3>
                                            <p class="text-light mt-1 m-0">Available</p>
                                        </div><!-- /.card-left -->
                        ...
                        <div class="col-sm-6 col-lg-4">
                                <div class="card text-white bg-flat-color-1">
                                    <div class="card-body">
                                        <div class="card-left pt-1 float-left">
                                            <h3 class="mb-0 fw-r">
                                                <span class="count">{{$notavailableassistant}}</span>
                                            </h3>
                                            <p class="text-light mt-1 m-0">Not Available</p>
                                        </div><!-- /.card-left -->
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="card text-white bg-flat-color-2">
                                    <div class="card-body">
                                        <div class="card-left pt-1 float-left">
                                            <h3 class="mb-0 fw-r">
                                                <span class="count">{{$assistant}}</span>
                                            </h3>
                                            <p class="text-light mt-1 m-0">Total Assistants</p>
                                        </div><!-- /.card-left -->
                                            ...
                                            <div class="stat-widget-four">
                                                ...
                                                <div class="stat-content">
                                                    <div class="text-left dib">
                                                        ...
                                                        <div class="stat-text">Total: {{$totalongoing}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="stat-widget-four">
                                                ...
                                                <div class="stat-content">
                                                    <div class="text-left dib">
                                                        <div class="stat-heading">Services Accomodated</div>
                                                        <div class="stat-text">Total: {{$totalservice}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
