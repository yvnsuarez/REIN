        ...
        <div class="card">
            ...
            {!! Form::open(['action' => ['Web\PartnerCompany\RequestsController@accept', $reports['ID']], 'method' =>'POST']) !!}
                        ...
                        <br/>
                                ...
                                <input type="button" value="Accept Request" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#Modal2"/>
                                <div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Are you sure you want to accept the service request?
                                            </div>
