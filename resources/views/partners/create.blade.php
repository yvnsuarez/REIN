                                ...
                                <div class="cub-input">
                                    <div class="text-input">
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="password" name="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" autocomplete="off">
                                            <span id="result"></span>
                                    ...
                                    <div class="text-input">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="CPassword" name="CPassword" class="form-control {{ $errors->has('CPassword') ? ' is-invalid' : '' }}" autocomplete="off">
